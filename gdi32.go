...
func SetROP2(hdc HDC, fnDrawMode int32) int32{
    ret, _, _ := syscall.Syscall(MustGetProcAddress(libgdi32, "SetROP2"), 2,
		uintptr(hdc),
		uintptr(fnDrawMode),
		0)
...
func GetROP2(hdc HDC)int32 {
    ret, _, _ := syscall.Syscall(MustGetProcAddress(libgdi32, "GetROP2"), 1,
		uintptr(hdc),
		0,
		0)
